...
namespace QuanlyNhahang
{
    public partial class fTableManager : Form
    {
        ...
        private void btnCheckOut_Click(object sender, EventArgs e)
        {
            ...
            if (idBill != -1)
            {
                if (MessageBox.Show(string.Format("Bạn có chắc thanh toán hóa đơn cho  {0} với\nTổng tiền - (Tổng tiền / 100) x Giảm giá\n" +
                    "=> {1} - ({1} /100) X {2} = {3} ( vnd ) ?",
        ...
        private void btnSwitchTable_Click_1(object sender, EventArgs e)
        {
            ...
            if (MessageBox.Show(string.Format("Bạn có thật sự muốn chuyển từ  {0} qua  {1}", (lsvBill.Tag as Table).Name, (cbSwitchTable.SelectedItem as Table).Name),
